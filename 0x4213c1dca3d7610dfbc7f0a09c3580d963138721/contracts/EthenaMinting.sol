...
contract EthenaMinting is IEthenaMinting, Ownable, AccessControl, ReentrancyGuard {
  ...
  function verifyRoute(Route calldata route, OrderType orderType) public pure override returns (bool) {
